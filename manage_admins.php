...
<body onload="load_admins(1);">
    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <div
                    ...
                    <div
                        ...
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2 active" href="manage_admins.php">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <p class="mt-2" style="font-size: 16px;"><i class="fa-regular fa-chart-bar" ></i> &nbsp; Manage Administration</p>
                <hr>

                <div class="border border-1 p-3 mb-3">
                    <label for="new_admin_email" class="form-label" style="font-size: 14px;">Email Address</label>
                    <input type="email" id="new_admin_email" class="form-control" aria-describedby="passwordHelpBlock" style="border-radius: 0;">
                    <div id="passwordHelpBlock" class="form-text mb-2">
                       Enter the email address of the person you want to add as a new admin. An invitation or notification will be sent to this email address to confirm their access.
                    </div>
                    <button style="font-size: 14px; border-radius: 0;" class="btn btn-primary d-grid col-12" onclick="appoint_admin();" id="appoint">Appoint a New Admin</button>
                    
                    <button class="btn btn-primary d-grid col-12 d-flex justify-content-center d-none" type="button" disabled style="font-size: 14px; border-radius: 0;"  onclick="appoint_admin();" id="sending_invitation">
                        <span class="spinner-grow spinner-grow-sm mt-1" aria-hidden="true"></span>&nbsp;&nbsp;
                        <span role="status">Sending email to new admin...</span>
                    </button>
                </div>

                <?php
                
                $num_of_sub_admins = Database::search("SELECT * FROM `admin`");
                $num = $num_of_sub_admins->num_rows;

                ?>
                <p><i class="bi bi-check2-circle"></i>&nbsp; Number of Sub Admins - <?php echo($num); ?></p>

                <div class="table-responsive small" id="admin_table">
                    <!-- Response -->
                </div>
            </main>
        </div>
    ...
    <script src="https://kit.fontawesome.com/022caddc83.js" crossorigin="anonymous"></script>
